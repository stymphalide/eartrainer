...
public class Menu {
    public Scene render(Button level1Start) {
        ...
        // Level 1 Setup
        String level1Description = "Some description"; // @TODO: add actual description
        final Label level1Label = new Label(""); // In order to be used in a lambda method this needs to be final.
